...
class Embedding_Net(nn.Module):
    def __init__(self, opt):
        ...
        self.fc1 = nn.Linear(opt.resSize, 512)
        self.fc12 = nn.Linear(512, opt.embedSize)
    ...
    def forward(self, features):
        ...
        embedding = self.relu(self.fc12(x))
...
class MLP_G(nn.Module):
    def __init__(self, opt):
        ...
        self.fc12 = nn.Linear(opt.ngh, 512)
        self.fc2 = nn.Linear(512, opt.resSize)
        self.lrelu = nn.LeakyReLU(0.2, True)
        # self.prelu = nn.PReLU()
        self.relu = nn.ReLU(True)
...
class MLP_CRITIC(nn.Module):
    def __init__(self, opt):
        ...
        self.fc1 = nn.Linear(opt.resSize + opt.attSize, 512)
        self.fc12 = nn.Linear(512, opt.ndh)
